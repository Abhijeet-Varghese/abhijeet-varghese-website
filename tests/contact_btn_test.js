...
(async () => {
  ...
  // mobile: menu shows 3 items + one button
  ...
  console.log(mobile.list.length === 3 && !mobile.list.some(t => t.includes('Start a conversation')) && mobile.ctaBtns === 1
    ? 'PASS  mobile menu: 3 items + 1 CTA button ' + JSON.stringify(mobile)
