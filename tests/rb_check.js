...
(async () => {
  ...
  await page.screenshot({ path: '/home/user/previews/rb-08-card8.png' });
  await seek(0.16); await page.waitForTimeout(2600);
  await page.screenshot({ path: '/home/user/previews/rb-03-card1-glass.png' });
  await seek(0.63); await page.waitForTimeout(2600);
  await page.screenshot({ path: '/home/user/previews/rb-06-interlude07.png' });
  await browser.close();
  console.log('RB SHOTS DONE');
})();
