...
export const CHROME: ChromeData = {
  ...
  mobile: [
    { label: 'Story', href: 'story.html', index: '01' },
    { label: 'Experience', href: 'experience.html', index: '02' },
    { label: 'Case Studies', href: 'case-studies.html', index: '03' },
    { label: 'Portfolio', href: 'portfolio.html', index: '04' },
  ],
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'For Recruiters', href: 'for-recruiters.html' },
