...
export interface Project {
  ...
  image: string;
  imageAlt: string;
  /** portfolio grid uses slightly different alt text than case-studies */
  portfolioAlt: string;
  role: string;
  year: string;
  /** short description used on portfolio + coming-soon pages */
  summary: string;
  /** case-study index panels */
  problem: string;
  approach: string;
  outcome: string;
  status: ProjectStatus;
  /** index used in portfolio grid ("01", "02", …) */
  index: string;
}
...
export const PROJECTS: Project[] = [
  {
    ...
    year: '2025',
    summary:
      'A strategy-led physical-digital experience created for executive engagement, product storytelling, immersive demonstration and collaboration.',
  ...
  },
  {
    ...
    imageAlt: 'BPCL — Energy & Industrial engagement',
    portfolioAlt: 'Intuitive Experiences for Industrial Environments — BPCL',
...
export const PORTFOLIO_SEO: SeoData = {
  ...
  description:
    'Selected portfolio work across experience design, creative direction, immersive technology, enterprise communication and spatial experiences.',
  keywords:
  ...
  jsonLd: {
    ...
    '@type': 'CollectionPage',
    name: 'Portfolio',
    url: 'https://abhijeetvarghese.com/portfolio.html',
    inLanguage: 'en',
    hasPart: [
      {
        '@type': 'CreativeWork',
        name: 'Orange Business New Executive Briefing Center',
        about: 'Experience Design & Creative Technology',
        image: 'https://abhijeetvarghese.com/assets/case-orange-experience-in-action.webp',
        url: 'https://abhijeetvarghese.com/experience-design/orange-business-executive-briefing-center/',
      },
      {
        '@type': 'CreativeWork',
        name: 'Intuitive Experiences for Industrial Environments',
        about: 'Energy & Industrial',
        image: 'https://abhijeetvarghese.com/assets/case-bpcl.webp',
        url: 'https://abhijeetvarghese.com/case-study-intuitive-experiences-for-industrial-environments.html',
      },
      {
        '@type': 'CreativeWork',
        name: 'Immersive Solutions for the Indian Army',
        about: 'Defence & Immersive',
        image: 'https://abhijeetvarghese.com/assets/case-army.webp',
        url: 'https://abhijeetvarghese.com/case-study-immersive-solutions-for-the-indian-army.html',
      },
    ],
  },
};
...
export const CASE_STUDIES_SEO: SeoData = {
  title: 'Case Studies — Abhijeet Varghese',
  description: 'Work that had to be understood.',
  keywords:
    'Abhijeet Varghese, creative director, experience design, enterprise innovation, UX design, design leadership, brand experience, immersive technology, AI design, creative strategy, experience centre, design consulting',
  canonical: 'https://abhijeetvarghese.com/case-studies.html',
  ogType: 'website',
  ogImage: 'https://abhijeetvarghese.com/assets/hero-portrait.webp',
  twitterCard: 'summary_large_image',
  jsonLd: {
    ...
    '@type': 'WebPage',
    name: 'Case Studies',
    url: 'https://abhijeetvarghese.com/case-studies.html',
    inLanguage: 'en',
  },
};
...
/** Generates the "coming soon" case-study SEO from a published project record. */
export function comingSoonSeo(p: Project): SeoData {
  ...
  return {
    ...
    ogImage: `https://abhijeetvarghese.com/${p.image}`,
    twitterCard: 'summary_large_image',
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
      ...
      description: p.summary,
      url: canonical,
      isPartOf: { '@type': 'CollectionPage', name: 'Case Studies', url: 'https://abhijeetvarghese.com/case-studies.html' },
      inLanguage: 'en',
    },
  };
}
