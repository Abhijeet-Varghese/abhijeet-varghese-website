...
<section className="journey t-light" id="journey">
      <div className="journey__pin" id="journeyPin">
        <header className="journey__head container">
          <div>
            <div className="chapter__meta" data-reveal={true}><span className="chapter__num">06</span><span className="chapter__rule"></span><span className="chapter__tag">Journey</span></div>
        ...
        <div className="journey__viewport">
          <ol className="journey__track" id="journeyTrack">
            ...
            <li className="era era--future" data-reveal={true}>
              <span className="era__index">09</span>
        ...
        <div className="journey__barwrap container">
          ...
          <p className="journey__counter" aria-hidden="true"><em>Era</em> <span id="journeyBarNum">01 / 09</span></p>
        </div>
      </div>
    </section>
