...
import { useInsightsHubMotion } from './hooks/useInsightsHubMotion';
import InsightsHubContent from './sections/insightsHub/InsightsHubContent';
...
export default function InsightsHubApp(){
  useMenu(); useReveal(); usePageMotion(); useElevate(); useMobileChrome(); useHistoryClose(); useAnalytics(); useServiceWorker(); useInsightsHubMotion();
  return (
    <>
      <SiteChrome activePath="/insights/" />
      <a className="page-close" href="/" data-history-close="" aria-label="Back to previous page"><CloseIcon /></a>
      <main id="main"><InsightsHubContent /></main>
      <SiteFooter />
    </>
  );
}
