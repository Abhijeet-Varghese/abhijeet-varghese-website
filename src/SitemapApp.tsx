...
export default function SitemapApp(){
  useMenu(); useReveal(); usePageMotion(); useElevate(); useMobileChrome(); useHistoryClose(); useAnalytics(); useServiceWorker(); useStaticMotion();
  return (
    <>
      <SiteChrome activePath="/sitemap/" />
      <a className="page-close" href="/" data-history-close="" aria-label="Back to previous page"><CloseIcon /></a>
      <main id="main"><SitemapContent /></main>
      <SiteFooter />
    </>
  );
}
