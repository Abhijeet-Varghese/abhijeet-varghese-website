...
import { useInsightArticleMotion } from './hooks/useInsightArticleMotion';
import InsightsEnterpriseContent from './sections/insightsEnterprise/InsightsEnterpriseContent';
...
export default function InsightsEnterpriseApp(){
  useMenu(); useReveal(); usePageMotion(); useElevate(); useMobileChrome(); useHistoryClose(); useAnalytics(); useServiceWorker();
  useCmsSeo('/insights/why-enterprise-experiences-fail/', { title: 'Why Enterprise Experiences Fail — Abhijeet Varghese' }); useInsightArticleMotion();
  return (
    <>
      <SiteChrome activePath="/insights/why-enterprise-experiences-fail/" />
      <a className="page-close" href="/" data-history-close="" aria-label="Back to previous page"><CloseIcon /></a>
      <main id="main"><InsightsEnterpriseContent /></main>
      <SiteFooter />
    </>
  );
}
