...
<div className="progress" id="progress" aria-hidden="true"></div>
  ...
  <main id="main">
    <section className="article-hero">
      <img className="article-hero__img" src="/assets/journal-01.webp" alt="Artwork for “What a year of AI-enabled production taught me”" width="1376" height="768" fetchpriority="high" decoding="async" />
      ...
      <div className="container article-hero__inner">
        <div className="chapter__meta" data-reveal={true}>
          ...
          <span className="chapter__tag">Journal · 4 min</span>
        </div>
        <h1 className="article-hero__title" data-reveal={true} style={{"--d": ".1s"}}>What a year of AI-enabled production taught me</h1>
        <p className="article-hero__lede" data-reveal={true} style={{"--d": ".2s"}}>Compression is the real gift.</p>
      </div>
    </section>
