    ...
    <section className="article-body t-light">
      <div className="container">
        ...
        <div className="article-foot" data-reveal={true}>
          <p style={{"color": "var(--cm)", "font-size": "0.95rem"}}>By <strong style={{"color": "var(--ct)"}}>Abhijeet Varghese</strong> · 2026-06-11</p>
