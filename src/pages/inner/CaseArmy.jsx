export default function CaseArmy() {
  return (
    <>
<div className="progress" id="progress" aria-hidden="true"></div>
  ...
  <main id="main">
    ...
    <section className="ia-section ia-hero" id="overview" data-chapter="Overview">
      <div className="ia-hero__media">
        ...
        <div className="ia-hero__shade" aria-hidden="true"></div>
      </div>
      <div className="ia-wrap ia-hero__copy">
        <div className="ia-hero__eyebrow ia-r">
          <span className="ia-label ia-label--bare"><b>Case study</b> Indian Army</span>
          <span className="ia-tri" aria-hidden="true"><i></i><i></i><i></i></span>
          <span className="ia-label ia-label--bare">Defence · Immersive Training</span>
        </div>
        <h1 className="ia-h1 ia-hero__title">
          <span className="ia-r ia-r--line"><span>Train before</span></span>
          <span className="ia-r ia-r--line"><span>the</span></span>
          <span className="ia-r ia-r--line"><span>battlefield.</span></span>
        </h1>
        <div className="ia-hero__row">
          <p className="ia-hero__sub ia-r" style={{"--d": ".3s"}}><strong>Immersive Training &amp; Qualification Ecosystem</strong> — an end-to-end immersive training environment designed to help Army personnel learn, practise and demonstrate competency before progressing toward physical training.</p>
          <dl className="ia-hero__meta ia-r" style={{"--d": ".4s"}}>
        ...
        <a className="ia-hero__scroll ia-r" style={{"--d": ".5s"}} href="#opening"><i aria-hidden="true"></i>Scroll to read</a>
      </div>
    </section>

      
    <section className="ia-section ia-section--tight" id="opening" aria-labelledby="h-opening">
      <div className="ia-wrap">
        <dl className="ia-strip ia-r">
    ...
    <section className="ia-section ia-section--navy ia-grid-bg" id="leadership" data-chapter="Leadership" aria-labelledby="h-lead">
      <div className="ia-wrap">
        <header className="ia-head ia-head--split">
          <span className="ia-label ia-r"><b>03</b> Project leadership</span>
          <h2 className="ia-h-big ia-r" id="h-lead">Not just an experience. <em>A training ecosystem.</em></h2>
          <p className="ia-lede ia-r" style={{"--d": ".1s"}}>I was involved in driving the experience from strategy through execution — translating Army requirements into an immersive training environment while coordinating the creative, content and delivery process.</p>
        </header>
        <div className="ia-cols">
          <div>
            <p className="ia-p ia-r">I worked directly with the <strong>Major on a daily basis</strong>, collaborating on requirements, progress, feedback and iterations.</p>
            <p className="ia-p ia-r" style={{"--d": ".06s"}}>I worked with the <strong>Colonel on a weekly basis</strong> for reviews, alignment, direction and feedback.</p>
            <p className="ia-p ia-r" style={{"--d": ".12s"}}>At senior review level, I coordinated the work through <strong>Brigadier-level approval</strong>.</p>
          </div>
          <div>
        ...
        <ol className="ia-bridge ia-r" style={{"--d": ".2s", "margin-top": "clamp(40px,5vw,64px)"}} aria-label="How the work flowed">
          ...
          <li className="is-me"><span>04</span><b>Team execution</b></li>
    ...
    <section className="ia-section" id="challenge" data-chapter="Challenge" aria-labelledby="h-challenge">
      <div className="ia-wrap">
        <div className="ia-statement">
          <span className="ia-label ia-r"><b>04</b> The opportunity</span>
          <h2 className="ia-h-big ia-r" id="h-challenge" style={{"--d": ".08s"}}>Before the battlefield, <em>there is a learning curve.</em></h2>
          <div className="ia-statement__rule ia-r" style={{"--d": ".16s"}}></div>
          <div className="ia-cols">
            <p className="ia-lede ia-r" style={{"--d": ".2s"}}>Complex operational training requires more than information. Personnel need an environment in which they can learn, practise, repeat and demonstrate their understanding before moving into physical training.</p>
            <div>
              <p className="ia-p ia-r" style={{"--d": ".24s"}}>The opportunity was to create an immersive digital layer that could sit between learning and physical training — allowing trainees to experience the training environment through VR while giving instructors visibility into the process.</p>
              <div className="ia-progression ia-r" style={{"--d": ".3s"}} role="list" aria-label="Training progression">
    ...
    <section className="ia-section ia-section--flush" id="ecosystem" data-chapter="Facility" aria-labelledby="h-facility">
      <figure className="ia-fig ia-bleed ia-parallax ia-r ia-r--img">
      ...
      <div className="ia-wrap" style={{"padding": "clamp(48px,6vw,88px) 0 var(--ia-section)"}}>
        <div className="ia-cols">
          <div className="ia-cols__side is-sticky">
            <p className="ia-lede ia-r">The physical foundation of the experience was a dedicated training room equipped with <strong>15 high-end computer stations</strong> for VR-based training.</p>
          </div>
          <div>
    ...
    <section className="ia-section ia-section--navy ia-section--flush" id="monitoring" data-chapter="Instructor view" aria-labelledby="h-instructor">
      <div className="ia-wrap" style={{"padding": "var(--ia-section) 0 clamp(40px,5vw,64px)"}}>
        <header className="ia-head ia-head--split">
          <span className="ia-label ia-r"><b>06</b> The instructor view</span>
          <h2 className="ia-h2 ia-r" id="h-instructor">Immersion for the trainee. <em>Visibility for the trainer.</em></h2>
          <p className="ia-lede ia-r" style={{"--d": ".1s"}}>Immersive training can become isolated if the instructor cannot see what is happening inside the experience. This system connected both sides.</p>
        </header>
      </div>
      <figure className="ia-fig ia-bleed ia-parallax ia-r ia-r--img">
        <div className="ia-fig__frame">
      ...
      <div className="ia-wrap" style={{"padding": "clamp(48px,6vw,80px) 0 var(--ia-section)"}}>
        <div className="ia-cols">
          <p className="ia-lede ia-r">Trainees remained immersed in their individual VR sessions, while the trainer retained a centralised view of the training activity through the main display.</p>
          <div>
            <p className="ia-p ia-r">This allowed instruction, observation and assessment to remain connected to the immersive experience. The trainer could see what each trainee was doing during their session — not after it — and guide the room accordingly.</p>
            <p className="ia-p ia-r" style={{"--d": ".08s"}}>Designing for the instructor with the same care as the trainee was one of the most important decisions in the project. It is what turned fifteen private experiences into one training environment.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="ia-wrap">
        <div className="ia-cols ia-cols--rev" style={{"align-items": "center"}}>
          <div className="ia-cols__side">
            ...
            <p className="ia-p ia-r" style={{"--d": ".14s"}}>Because trainee activity was visible on the central display, the trainer could observe individual sessions, follow progress through the training and bring attention to a specific trainee when needed.</p>
            <p className="ia-p ia-r" style={{"--d": ".2s"}}>The same visibility carried into assessment: what the trainer observed during practice became the basis for evaluating readiness to qualify.</p>
          </div>
      ...
      <div className="ia-wrap">
        <div className="ia-cols ia-cols--eq" style={{"align-items": "center"}}>
          <div className="ia-cols__side">
            ...
            <p className="ia-lede ia-r" style={{"--d": ".14s"}}>Learn inside the machine.</p>
            <p className="ia-p ia-r" style={{"--d": ".2s"}}>The T-90 was brought into the immersive training environment as part of the digital learning and practice experience.</p>
            <p className="ia-p ia-r" style={{"--d": ".26s"}}>The goal was to give trainees an immersive environment in which they could engage with the training experience before progressing to the next stage of training.</p>
          </div>
          <figure className="ia-fig ia-r ia-r--img" style={{"--d": ".1s"}}>
            <div className="ia-fig__frame">
              <i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i>
      ...
      <div className="ia-wrap">
        <div className="ia-cols ia-cols--eq ia-cols--rev" style={{"align-items": "center"}}>
          <div className="ia-cols__side">
            ...
            <p className="ia-lede ia-r" style={{"--d": ".14s"}}>The same immersive training principle.</p>
            <p className="ia-p ia-r" style={{"--d": ".2s"}}>The T-70 was integrated into the same broader immersive training approach.</p>
            <p className="ia-p ia-r" style={{"--d": ".26s"}}>Rather than treating each platform as an isolated experience, the project established a consistent digital training framework across the two platforms.</p>
          </div>
          <figure className="ia-fig ia-r ia-r--img" style={{"--d": ".1s"}}>
            <div className="ia-fig__frame">
              <i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i>
    ...
    <section className="ia-section ia-section--flush" id="framework" aria-labelledby="h-framework">
      <figure className="ia-fig ia-bleed ia-parallax ia-r ia-r--img">
        <div className="ia-fig__frame">
      ...
      <div className="ia-wrap" style={{"padding": "clamp(48px,6vw,80px) 0 var(--ia-section)"}}>
        <div className="ia-cols ia-cols--eq" style={{"align-items": "start"}}>
          ...
          <ol className="ia-chain ia-chain--compact ia-r" style={{"--d": ".1s"}} aria-label="Training logic">
            ...
            <li className="is-end"><span>↓</span><b>Physical training</b></li>
          </ol>
        </div>
      </div>
    </section>
    ...
    <section className="ia-section ia-section--graphite" id="inside" aria-labelledby="h-inside">
      <div className="ia-wrap--wide">
        <figure className="ia-fig ia-r ia-r--img">
          <div className="ia-fig__frame">
            <i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i>
      ...
      <div className="ia-wrap" style={{"margin-top": "clamp(36px,5vw,64px)"}}>
        <div className="ia-cols">
          <div className="ia-cols__side">
            ...
            <h2 className="ia-h2 ia-r" id="h-inside" style={{"--d": ".08s"}}>Inside <em>the experience.</em></h2>
          </div>
          <div>
    ...
    <section className="ia-section ia-section--flush" id="session" aria-labelledby="h-session">
      <figure className="ia-fig ia-bleed ia-parallax ia-r ia-r--img">
        <div className="ia-fig__frame">
      ...
      <div className="ia-wrap" style={{"padding": "clamp(48px,6vw,80px) 0 var(--ia-section)"}}>
        <div className="ia-cols">
          <div className="ia-cols__side">
            <span className="ia-label ia-r"><b>12</b> One station, one trainee</span>
            <h2 className="ia-h2 ia-r" id="h-session" style={{"--d": ".08s"}}>Individual immersion. <em>Shared visibility.</em></h2>
          </div>
          <div>
            <p className="ia-p ia-r">Each of the fifteen stations ran an individual VR session. What a trainee experienced was theirs alone — but what they were doing was visible to the trainer on the central display. That pairing of individual immersion and centralised visibility is the defining relationship of the ecosystem.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="ia-section" id="qualification" data-chapter="Qualification" aria-labelledby="h-qual">
      <div className="ia-wrap">
        <header className="ia-head ia-head--split">
          <span className="ia-label ia-r"><b>13</b> Qualification testing</span>
          <h2 className="ia-h2 ia-r" id="h-qual">Training became <em>assessable.</em></h2>
          <p className="ia-lede ia-r" style={{"--d": ".1s"}}>The immersive environment also became the setting for qualification testing.</p>
        </header>
        <figure className="ia-fig ia-r ia-r--img">
          <div className="ia-fig__frame">
            <i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i>
        ...
        <div className="ia-cols" style={{"margin-top": "clamp(36px,5vw,64px)"}}>
          ...
          <div>
            ...
            <div className="ia-progression ia-r" style={{"--d": ".08s"}} role="list" aria-label="Transition">
    ...
    <section className="ia-section ia-section--graphite" id="performance" aria-labelledby="h-perf">
      <div className="ia-wrap">
        <div className="ia-cols">
          <div className="ia-cols__side is-sticky">
            <span className="ia-label ia-r"><b>14</b> Assessment</span>
            <h2 className="ia-h2 ia-r" id="h-perf" style={{"--d": ".08s"}}>What the trainer saw <em>became the decision.</em></h2>
            <p className="ia-p ia-r" style={{"--d": ".14s"}}>Assessment drew on the same central visibility the trainer used during practice: which trainees had worked through the training, how they had performed inside the environment, and who was ready to qualify.</p>
            <p className="ia-p ia-r" style={{"--d": ".2s"}}>That is what allowed qualification to be a considered stage rather than a formality.</p>
          </div>
          <figure className="ia-fig ia-r ia-r--img">
            <div className="ia-fig__frame">
              <i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i>
    ...
    <section className="ia-section ia-section--flush ia-qualified" id="qualified" aria-labelledby="h-qualified">
      <figure className="ia-fig ia-bleed ia-parallax ia-r ia-r--img">
        <div className="ia-fig__frame">
      ...
      <div className="ia-wrap" style={{"padding": "clamp(48px,6vw,80px) 0 var(--ia-section)"}}>
        <div className="ia-cols">
          <p className="ia-lede ia-r">Qualification created a defined stage between digital learning and physical training.</p>
          <div>
            <p className="ia-p ia-r">The immersive environment could therefore function not only as a training space, but also as a point at which trainees demonstrated their competency before progressing further.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="ia-section ia-section--navy ia-section--flush" id="physical" data-chapter="Digital → Physical" aria-labelledby="h-gate">
      <div className="ia-wrap" style={{"padding": "var(--ia-section) 0 clamp(40px,5vw,64px)"}}>
      ...
      <figure className="ia-fig ia-bleed ia-gate ia-r ia-r--img">
        <div className="ia-fig__frame">
          ...
          <div className="ia-gate__veil" aria-hidden="true"></div>
          <div className="ia-gate__line" aria-hidden="true"></div>
        </div>
      ...
      <div className="ia-wrap" style={{"padding": "clamp(48px,6vw,80px) 0 var(--ia-section)"}}>
        <div className="ia-cols ia-cols--eq" style={{"align-items": "start"}}>
          ...
          <ol className="ia-chain ia-r" style={{"--d": ".1s"}} aria-label="Digital to physical progression">
            ...
            <li className="is-end"><span>03</span><b>Physical<small>Physical / battlefield training</small></b></li>
          </ol>
        </div>
      </div>
    </section>
    ...
    <section className="ia-section ia-section--flush" id="battlefield" aria-labelledby="h-battlefield">
      <figure className="ia-fig ia-bleed ia-parallax ia-r ia-r--img">
        <div className="ia-fig__frame">
      ...
      <div className="ia-wrap" style={{"padding": "clamp(48px,6vw,80px) 0 var(--ia-section)"}}>
        <div className="ia-cols">
          <p className="ia-lede ia-r">The digital environment was one stage of a larger training journey.</p>
          <div>
            <p className="ia-p ia-r">After demonstrating competency within the immersive environment, personnel could progress toward physical training. The experience therefore connected two worlds: <strong>immersive practice</strong> and <strong>physical training</strong>.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="ia-section ia-section--graphite" id="journey" data-chapter="Journey" aria-labelledby="h-journey">
      <div className="ia-wrap">
        <header className="ia-head">
    ...
    <section className="ia-section" id="project-system" aria-labelledby="h-arch">
      <div className="ia-wrap">
        <header className="ia-head ia-head--split">
          <span className="ia-label ia-r"><b>19</b> System architecture</span>
        ...
        <div className="ia-cols ia-cols--eq" style={{"align-items": "start"}}>
          <ol className="ia-chain ia-r" aria-label="System architecture">
            ...
            <li className="is-end"><span>06</span><b>Physical training</b></li>
          </ol>
          <figure className="ia-fig ia-r ia-r--img" style={{"--d": ".1s"}}>
            <div className="ia-fig__frame">
              <i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i>
    ...
    <section className="ia-section ia-section--navy" id="content" aria-labelledby="h-content">
      <div className="ia-wrap">
        <div className="ia-cols">
          <div className="ia-cols__side is-sticky">
            <span className="ia-label ia-r"><b>20</b> Content development</span>
            <h2 className="ia-h2 ia-r" id="h-content" style={{"--d": ".08s"}}>The experience was built <em>around the training.</em></h2>
            <p className="ia-lede ia-r" style={{"--d": ".14s"}}>My role extended beyond the visual layer.</p>
            <p className="ia-p ia-r" style={{"--d": ".2s"}}>I was involved in shaping the experience and content that trainees encountered inside the immersive environment, translating requirements into a structured training journey and coordinating its development through iteration and stakeholder feedback.</p>
          </div>
          <figure className="ia-fig ia-r ia-r--img">
            <div className="ia-fig__frame">
              <i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i><i className="ia-fig__tick"></i>
    ...
    <section className="ia-section ia-grid-bg" id="stakeholders" data-chapter="Stakeholders" aria-labelledby="h-stake">
      <div className="ia-wrap">
        <header className="ia-head ia-head--split">
          <span className="ia-label ia-r"><b>21</b> Stakeholder management</span>
          <h2 className="ia-h-big ia-r" id="h-stake">Working at the speed <em>of the stakeholder.</em></h2>
          <p className="ia-lede ia-r" style={{"--d": ".1s"}}>Three cadences ran through the whole project. Each one was mine to prepare for, present to and act on.</p>
        </header>
        <ol className="ia-cadence" aria-label="Stakeholder cadence">
          <li className="ia-r"><span>Daily</span><h3>Major<em>Direct collaboration</em></h3><p>Working through requirements, reviewing progress, discussing feedback, aligning the experience, resolving issues and driving iterations.</p><div className="ia-cadence__tags"><span>Requirements</span><span>Feedback</span><span>Iteration</span><span>Progress</span></div></li>
    ...
    <section className="ia-section ia-section--navy" id="role" data-chapter="My role" aria-labelledby="h-role">
      <div className="ia-wrap">
        <header className="ia-head ia-head--split">
          <span className="ia-label ia-r"><b>22</b> My role</span>
          <h2 className="ia-h2 ia-r" id="h-role">Led the experience, <em>end to end.</em></h2>
          <p className="ia-lede ia-r" style={{"--d": ".1s"}}>Strategy, direction, content, stakeholders, team and execution — held together across the lifecycle of the project rather than handed off after the concept.</p>
        </header>
        <ol className="ia-role">
          <li className="ia-r"><span>01</span><h3>Experience strategy</h3><p>Defined how the immersive experience could support the broader training journey.</p></li>
          <li className="ia-r" style={{"--d": ".06s"}}><span>02</span><h3>Creative direction</h3><p>Shaped the overall experience, storytelling and creative approach.</p></li>
          <li className="ia-r" style={{"--d": ".12s"}}><span>03</span><h3>Immersive experience</h3><p>Directed how trainees would encounter and move through the digital environment.</p></li>
          <li className="ia-r" style={{"--d": ".18s"}}><span>04</span><h3>Content development</h3><p>Created and shaped the content required for the immersive training experience.</p></li>
          <li className="ia-r" style={{"--d": ".24s"}}><span>05</span><h3>Stakeholder management</h3><p>Worked directly with the Major, the Colonel and the Brigadier-level approval process.</p></li>
          <li className="ia-r" style={{"--d": ".3s"}}><span>06</span><h3>Team leadership</h3><p>Coordinated the team responsible for developing and executing the experience.</p></li>
          <li className="ia-r" style={{"--d": ".36s"}}><span>07</span><h3>Client coordination</h3><p>Managed feedback, iterations, reviews and alignment.</p></li>
          <li className="ia-r" style={{"--d": ".42s"}}><span>08</span><h3>Execution</h3><p>Stayed involved across the lifecycle rather than handing off the work after strategy or concept development.</p></li>
        </ol>
      </div>
    </section>
    ...
    <section className="ia-section" id="human" aria-labelledby="h-human">
      <div className="ia-wrap">
        <div className="ia-cols ia-cols--eq" style={{"align-items": "center"}}>
          ...
          <div className="ia-cols__side">
            <span className="ia-label ia-r"><b>23</b> Human experience</span>
            <h2 className="ia-h2 ia-r" id="h-human" style={{"--d": ".08s"}}>Behind every system <em>is a trainee.</em></h2>
            <p className="ia-lede ia-r" style={{"--d": ".14s"}}>The technology was only valuable if it made the training experience understandable, immersive and assessable for the person using it.</p>
            <p className="ia-p ia-r" style={{"--d": ".2s"}}>The work therefore had to operate at two levels simultaneously: <strong>the individual trainee experience</strong>, and <strong>the instructor's ability to understand and guide that experience.</strong></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="ia-section ia-section--flush" id="impact-visual" aria-labelledby="h-imm">
      <figure className="ia-fig ia-bleed ia-parallax ia-r ia-r--img">
        <div className="ia-fig__frame">
    ...
    <section className="ia-section ia-section--navy" id="outcome" data-chapter="Outcome" aria-labelledby="h-impact">
      <div className="ia-wrap">
        <header className="ia-head ia-head--split">
          <span className="ia-label ia-r"><b>25</b> Impact</span>
          <h2 className="ia-h2 ia-r" id="h-impact">What the system <em>created.</em></h2>
          <p className="ia-lede ia-r" style={{"--d": ".1s"}}>Six qualities the training environment brought to Army personnel and their instructors.</p>
        </header>
        <ol className="ia-principles">
          <li className="ia-r"><span>01</span><h3>Immersive</h3><p>Training moved beyond passive observation into active participation.</p></li>
          <li className="ia-r" style={{"--d": ".06s"}}><span>02</span><h3>Repeatable</h3><p>The digital environment provided a space for repeated practice.</p></li>
          <li className="ia-r" style={{"--d": ".12s"}}><span>03</span><h3>Connected</h3><p>Individual trainee experiences remained visible to the instructor.</p></li>
          <li className="ia-r" style={{"--d": ".18s"}}><span>04</span><h3>Assessable</h3><p>Qualification testing became part of the immersive environment.</p></li>
          <li className="ia-r" style={{"--d": ".24s"}}><span>05</span><h3>Progressive</h3><p>Training could move from digital practice toward physical training.</p></li>
          <li className="ia-r" style={{"--d": ".3s"}}><span>06</span><h3>Systemic</h3><p>The project connected people, content, technology, instruction and qualification into one training ecosystem.</p></li>
        </ol>
      </div>
    </section>
    ...
    <section className="ia-section ia-section--graphite ia-section--tight" id="summary" aria-labelledby="h-summary">
      <div className="ia-wrap">
        <div className="ia-cols">
          <div className="ia-cols__side is-sticky">
            <span className="ia-label ia-r"><b>27</b> Project information</span>
            <h2 className="ia-h2 ia-r" id="h-summary" style={{"--d": ".08s"}}>At a glance.</h2>
          </div>
          <dl className="ia-facts ia-r">
            <div><dt>Client</dt><dd>Indian Army</dd></div>
    ...
    <section className="ia-section ia-section--flush ia-closing" id="closing" aria-labelledby="h-closing">
      <div className="ia-wrap" style={{"padding": "var(--ia-section) 0 clamp(40px,5vw,64px)"}}>
        <div className="ia-cols">
          <div className="ia-cols__side">
        ...
        <div className="ia-bleed__overlay">
          <div className="ia-wrap ia-closing__panel">
            ...
            <div className="ia-closing__cta ia-r" style={{"--d": ".2s"}}>
              <span className="ia-label ia-label--bare">Continue</span>
              <a className="ia-btn ia-btn--solid" href="/contact/">Start a conversation <svg viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M2 8h11M9 3.5 13.5 8 9 12.5" stroke="currentColor" strokeWidth="1.6" /></svg></a>
              <a className="ia-btn" href="/case-studies/orange-business/">Next case study · Orange Business <svg viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M2 8h11M9 3.5 13.5 8 9 12.5" stroke="currentColor" strokeWidth="1.6" /></svg></a>
            </div>
          </div>
        </div>
        <figcaption className="visually-hidden">Train before the battlefield.</figcaption>
      </figure>
      <div className="ia-wrap">
        <div className="ia-closing__foot">
  ...
  <nav className="e-next" aria-label="Next case study">
    <div className="e-next__in">
      ...
      <p className="e-next__title"><a href="/case-studies/orange-business/">Orange Business <svg width="30" height="30" viewBox="0 0 30 30" fill="none" aria-hidden="true"><path d="M4 15h19M17 8.5 23.5 15 17 21.5" stroke="currentColor" strokeWidth="1.8" /></svg></a></p></div>
