...
import { useConsultingMotion } from './hooks/useConsultingMotion';
import ConsultingContent from './sections/consulting/ConsultingContent';
...
export default function ConsultingApp(){
  useMenu(); useReveal(); usePageMotion(); useElevate(); useMobileChrome(); useHistoryClose(); useAnalytics(); useServiceWorker(); useConsultingMotion();
  return (
    <>
      <SiteChrome activePath="/consulting/" />
      <a className="page-close" href="/" data-history-close="" aria-label="Back to previous page"><CloseIcon /></a>
      <main id="main"><ConsultingContent /></main>
      <SiteFooter />
    </>
  );
}
