...
import { useJournalMotion } from './hooks/useJournalMotion';
import JournalContent from './sections/journal/JournalContent';
...
export default function JournalApp(){
  useMenu(); useReveal(); usePageMotion(); useElevate(); useMobileChrome(); useHistoryClose(); useAnalytics(); useServiceWorker(); useJournalMotion();
  return (
    <>
      <SiteChrome activePath="/journal/" />
      <a className="page-close" href="/" data-history-close="" aria-label="Back to previous page"><CloseIcon /></a>
      <main id="main"><JournalContent /></main>
      <SiteFooter />
    </>
  );
}
